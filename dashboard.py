...
# --- PROSES DATA & AI ---
@st.cache_data # Supaya website tidak loading ulang terus menerus
...
# Jalankan fungsi di atas
df_tabel, hasil_prediksi, harga_hari_ini = ambil_data_dan_prediksi()

# --- TAMPILAN UTAMA ---
col1, col2 = st.columns([2, 1]) # Membagi layar jadi 2 kolom (kiri lebar, kanan sempit)

with col1:
    st.subheader("📊 Grafik Harga Emas 30 Hari Terakhir")
    # Menampilkan grafik garis harga penutupan
...
with col2:
    ...
    st.info(f"🛡️ **Safety Info:**\nJangan rugi lebih dari **${rugi_max:.2f}** hari ini!")
